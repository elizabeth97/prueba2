<%@ Page Title="" Language="C#" MasterPageFile="~/mstPrincipal.master" AutoEventWireup="true" CodeFile="actividad3.aspx.cs" Inherits="actividad3" %>
    ...
    <div class="auto-style34">&nbsp;<nav class="navbar navbar-inverse">
            <div class="container-fluid">
                 ...
                 <ul class="nav navbar-nav"  style="height: 60px;color:cadetblue; width: 1370px; margin-top: 0px; margin-left: 19px; margin-bottom: 0px;">
                        ...
                        <li class="active" style="left: 0px; top: 0px; height: 56px;"><a href="#">Primero</a></li>
